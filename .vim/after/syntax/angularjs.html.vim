...
syn region angularScriptTemplate start=+<script [^>]*type *=[^>]*text/ng-[^>]*>+
\                       end=+</script>+me=s-1 keepend
\                       contains=htmlHead,htmlTitle,htmlString,htmlH1,htmlH2,htmlH3,htmlH4,htmlH5,htmlH6,htmlTag,htmlEndTag,htmlTagName,htmlSpecialChar,htmlLink,htmlBold,htmlUnderline,htmlItalic
