...
command! -range=% PDF silent <line1>,<line2>w !pandoc -f markdown -s --toc -V geometry:margin=1in --variable monofont="Source Code Pro" --variable mainfont="Source Code Pro" -o $TMPDIR/%:t:r.pdf --filter pandoc-plantuml-filter && open $TMPDIR/%:t:r.pdf
