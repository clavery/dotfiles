...
command! -range=% DOCX <line1>,<line2>w !pandoc --reference-doc=/Users/clavery/Nextcloud/Todo/Wiki/PixelMedia/reference.docx -f markdown -s --toc -o $TMPDIR/%:t:r.docx && open $TMPDIR/%:t:r.docx
