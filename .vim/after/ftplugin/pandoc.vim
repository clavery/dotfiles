...
command! -range=% DOCX <line1>,<line2>w !pandoc --reference-docx=/Users/clavery/Dropbox/Todo/Wiki/PixelMedia/reference.docx -f markdown -s --toc -o $TMPDIR/%:t:r.docx && open $TMPDIR/%:t:r.docx
command! -range=% SLIDES <line1>,<line2>w !pandoc -f markdown -t revealjs -s -V revealjs-url='file:///Users/clavery/code/reveal.js/' --slide-level 2 -o $TMPDIR/%:t:r.html && open $TMPDIR/%:t:r.html
