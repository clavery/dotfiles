...
command! -range=% PDF silent <line1>,<line2>w !pandoc -f markdown -s -V geometry:margin=1in -o $TMPDIR/%:t:r.pdf && open $TMPDIR/%:t:r.pdf
command! -range=% PDF2 silent <line1>,<line2>w !pandoc -f markdown -s -o $TMPDIR/%:t:r.pdf && open $TMPDIR/%:t:r.pdf
